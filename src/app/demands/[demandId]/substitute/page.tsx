...
//
// 수요 세그먼트(`/demands/[demandId]/substitute`)에 둔다 — 특정 수요의 대체 제안 상세라 B-12
// 수요 상세와 같은 셸(demands/layout, MobileScreenShell)을 공유한다. backHref는 목록(/waiting)으로.
//
...
// 타이핑한다(형제 `[demandId]/page.tsx`와 같은 이유).
